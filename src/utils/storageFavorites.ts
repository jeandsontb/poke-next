...
const pokemonsFavorited = (): number[] => {
  return JSON.parse(localStorage.getItem(decorator.favorites) || "[]");
};

export default { getSaveFavorites, existsPokemonFavorites, pokemonsFavorited };
